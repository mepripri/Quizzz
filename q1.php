<html>
        ...
        <script>
            ...
            function check(pr)
            {
                if(pr == "Brian Lara")
                {
                    ...
                    score+=1;
                    setTimeout(function(){window.location.href='q2.php?'+score},2000);
                }
                else if(pr == "Don Bradman")
                {
                    var t=document.getElementById("bu");
                    t.style.backgroundColor="green";
                    t.style.borderColor="green";
    ...
    <body>
        ...
        <div>
            <div class="two">
                <div class="three"><br>Q1.Which cricketer had scored highest individual score in first-class cricket?</div>
                <br>
                <button id="bue" class="bu1" onclick="check('Don Bradman')">Don Bradman</button>
                <button id="bu"  class="bu2" onclick="check('Brian Lara')">Brian Lara</button>
                <button id="buf" class="bu3" onclick="check('Lane Hutton')">Lane Hutton</button>
                <button id="bug" class="bu4" onclick="check('Gary Sobers')">Gary Sobers</button>
            </div>
        </div>
    </body>
</html>
