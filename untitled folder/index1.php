      ...
      <div class="aa-header">
          ...
          <div class="container"><a class="navbar-brand px-0 py-0" style="font-size: 40px;font-family: 'Dosis', 'Helvetica', Arial, sans-serif;"; href="index.html">Quizzes</a>
            <div class="collapse navbar-collapse">
              <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="cricket.html">Quizzes</a></li>
                <li class="nav-item"><a class="nav-link" href="#pricing">Scores</a></li>
                <li class="nav-item"><a class="btn btn-outline-neutral btn-round" href="ContactFrom_v1/signup.html"><?php echo $user; ?></a></li>
              </ul>
            </div>
          </div>
        </nav>
        <div class="container aa-header-content text-left text-white">
          <div class="row">
            ...
            <div class="col-md-6 col-sm-13 text-right"><img class="img-fluid" src="images/cartoon-elephant-cliparts-5.jpg" alt="Image" style="height: 400px;width: 500px;"></div>
          </div>
        </div>
      </div>
    </header>
...
<div class="aa-product-features section" style="background-image: url('images/home-image.jpg');";>
  <div class="container">
    <div class="row">
        <div class="col-md-7 col-sm-12"><br>
        <h2 class="title mb-2" style="color: white">Graphics Trivial</h2>
        <p class="pt-2" style="color: white">Can You Pass The Easiest Computer Graphics Trivia Questions? This quiz is perfect for someone who has just begun learning about computer graphics and wants to see just how much knowledge they have gathered. If you are one of those people, be sure to give it a try and keep an eye out for other quizzes like this to increase your knowledge.</p>
        <a class="mt-4 btn btn-outline-neutral btn-round" href="cricket.html">Start Game</a> 
      </div>
      <div class="col-md-5 col-sm-12"><img class="img-fluid" src="images/1568276969.jpg" alt="Image" style="border-radius: 20px;height: 300px;width: 600px;" /></div>
    </div>
  </div>
</div>
</br></br>
