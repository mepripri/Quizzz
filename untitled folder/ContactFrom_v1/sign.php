...
<body>
      ...
      <div style="background-image:url('header/images/home-image.jpg');">
        <nav class="navbar navbar-expand-md navbar-transparent" style="padding-bottom: 42px;">
          <div class="container"><a class="navbar-brand px-0 py-0" style="font-size: 40px;font-family: 'Dosis', 'Helvetica', Arial, sans-serif;"; href="index.html">Quizzes</a>
            <div class="collapse navbar-collapse">
              <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="http://localhost/ProjectPHPPri/cricket.php">Quizzes</a></li>
      ...
      <center>
	<div style="background-image:url('header/images/home-image.jpg');min-height: 630px;">
